####### This code gives stft feats of 1024 dim #######
...
# print("feats for file",file,  normalize(amp_to_db(np.abs(stft))-20))
 np.savetxt(new_folder+'/'+file.split('.')[0]+'.feats', normalize(amp_to_db(np.abs(stft))-20))
