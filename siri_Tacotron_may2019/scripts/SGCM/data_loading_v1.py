...
class arctic_database(Dataset):
    ...
    def __init__(self, txt_file, wav_name):
...
#       for file in self.wav_name:
        print("file in get item is", file)
        loaded_wave = load_wav(self.wav_name)
...
#print("wav_name is", wav_name, files)
for file in files:
  print("fiile going is", file)
  datas = arctic_database(text_array, file)
...
fiile going is arctic_a0008.wav
entering class arctic_a0008.wav
len of txt file is 9
file in get item is arctic_a0008.wav
file in get item is arctic_a0008.wav
file in get item is arctic_a0008.wav
file in get item is arctic_a0008.wav
slt is 4
...
file in get item is arctic_a0008.wav
slt is 1
fiile going is arctic_a0009.wav
entering class arctic_a0009.wav
len of txt file is 9
file in get item is arctic_a0009.wav
file in get item is arctic_a0009.wav
file in get item is arctic_a0009.wav
file in get item is arctic_a0009.wav
slt is 4
